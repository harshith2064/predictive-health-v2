...
st.markdown("""
    <style>
        ...
        .predict-button {
            ...
            box-shadow: 0 4px 12px rgba(26, 117, 255, 0.3) !important;
            width: 100% !important;
        ...
        /* FIXED: Simple reasoning text styling - Dark blue, no complex boxes */
        .reasoning-text {
            color: #1e40af !important;
...
with col2:
    ...
    bmi = st.number_input("⚖ BMI", min_value=0.0, format="%.1f", help="Body Mass Index")
...
# Prediction Button
if st.button("🔬 Analyze Diabetes Risk", key="predict_btn"):
    if not patient_name.strip():
        ...
        if len(shap_vals) == len(feature_names):
            ...
            st.markdown('<div class="custom-warning">⚠ Could not generate feature impact chart due to data mismatch.</div>', unsafe_allow_html=True)

        st.markdown("</div>", unsafe_allow_html=True)

        # Model Explanation Section - SIMPLIFIED AND FIXED
        st.markdown("""
        <div class="section-card">
            <div class="section-title">
                🧠 AI Model Reasoning
        ...
        # Simple bullet points with dark blue text - no complex styling
